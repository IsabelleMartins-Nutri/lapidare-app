...
const MAIS_ITEMS = [
  ...
  { path: '/paciente/receitas',    icon: 'tools-kitchen-2', label: 'Receitas',           sub: 'Compartilhadas pela Dra.' },
...
const HEADERS = {
  ...
  '/paciente/receitas':     () =>                ({ eyebrow: 'Cozinha',          title: 'Receitas',          subtitle: 'Compartilhadas pela sua nutri' }),
        ...
        <nav className="tabbar" role="tablist">
          {TABS.map(t => {
            const active = t.path
              ...
              : ['/paciente/compras', '/paciente/suplementos', '/paciente/habitos', '/paciente/prescricoes', '/paciente/ebooks', '/paciente/receitas', '/paciente/beneficios', '/paciente/chat'].includes(location.pathname);
